...
<div class="container flex flex-col items-end justify-start mt-10 py-8">
    <div class="formContainer flex flex-col items-center">
        <h1 class="px-12 py-4 w-10/12 text-2xl pb-12 font-bold">Créer une nouvelle catégorie</h1>
        <form class="w-full flex justify-center" action="/admin/categories/store" method="post">
            @csrf
