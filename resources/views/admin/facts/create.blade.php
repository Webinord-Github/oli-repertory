...
<div class="container flex flex-col items-end justify-start mt-10 py-8">
    <div class="formContainer flex flex-col items-center">
        <h1 class="px-12 py-4 w-10/12 text-2xl pb-12 font-bold">Créer une nouvelle fiche saviez-vous</h1>
        <form class="w-full flex justify-center" action="/admin/facts/store" method="post" enctype="multipart/form-data">
            @csrf
            <div class="px-12 pb-8 flex flex-col items-center w-10/12">
                ...
                <div class="w-full mb-2">
                    <div class="flex justify-center flex-col">
                        ...
                        <x-input id="url" class="block mt-1 w-full" type="url" name="url" :value="old('url')" placeholder="https://example.com" required autofocus />
                    </div>
                </div>
