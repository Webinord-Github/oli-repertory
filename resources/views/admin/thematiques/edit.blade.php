...
<div class="container flex flex-col items-end justify-start mt-10 py-8">
    <div class="formContainer flex flex-col items-center">
        <h1 class="px-12 py-4 w-10/12 text-2xl pb-12 font-bold">Modifier une thématique</h1>
        <form class="w-full flex justify-center" action="/admin/thematiques/update/" method="post">
            @csrf
            ...
            <div class="px-12 pb-8 flex flex-col items-center w-10/12">
                ...
                <div class="flex items-center justify-end mt-4">
                    <a href="/admin/thematiques">Retour</a>
                    <x-button class="ml-4">
                        {{ __('Modifier') }}
                    </x-button>
                </div>
