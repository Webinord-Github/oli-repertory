...
<div class="container">
    ...
    <div class="pagesContainer">
        <h1 class="text-4xl font-bold pb-6">Vérification des utilisateurs</h1>
        @if (session('success'))
        ...
        <table class="w-full text-sm text-left text-gray-500">
            <thead class="text-xs text-gray-700 uppercase bg-gray-50">
                <tr>
                    ...
                    <th scope="col" class="px-6 py-3">Bloqué</th>
                </tr>
            </thead>
            <form method="POST" action="{{ route('usersguard.store') }}">
                ...
                <tbody>
                    ...
                    <tr class="bg-white border-b">
                        ...
                        <td class="px-6 py-4">
                            <button data-user-id="{{$user->id}}" data-user-name="{{$user->name}}" class="user__ban" href="">Bloquer l'utilisateur</button>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
...
<div class="ban__container">
    <div class="ban__popup">
        <h2>Voulez-vous bloquer l'utilisateur suivant?</h2>
...
<script>
    let userBans = document.querySelectorAll(".user__ban")
